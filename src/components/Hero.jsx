      ...
      <div className="home flex flex-col-reverse md:flex-row items-start my-12 md:my-6">
        <div className="left flex flex-col justify-center items-start  my-4 md:my-0 md:w-[50%] md:pl-[6%] bg">
          ...
          <div className=" ">
            ...
            />
            <button className="bg-[#3461FF] p-3 hover:bg-[#E0FF22] hover:text-black transition-all text-white rounded-full px-4">
              Let's Talk
            </button>
          </div>
        </div>
        <div className="right flex flex-col ">
          ...
          <div className="middle  flex justify-center items-start">
            <div className="2 relative w-44 h-44 object-cover rounded-full  bg-[#3461FF]">
              <span className="absolute top-[33%] left-[33%] text-4xl   md:text-6xl">
                ✏️
              </span>
            </div>
            <img
          ...
          <div className="bottom relative flex justify-center items-start">
            ...
            <img
              ...
              alt=""
            />
            <div className="5 -z-10 relative w-36 h-44 object-cover rounded-full e bg-[#F1F4FF]">
              <span className="absolute text-4xl   md:text-6xl top-[33%] left-[28%]">
                🧑🏻‍💻
              </span>
            </div>
            <div className="6 relative w-36 h-44 object-cover rounded-full  bg-[#E0FF22]">
              <span className="absolute text-4xl  md:text-6xl top-[33%] left-[30%] animate-pulse">
                👑
              </span>
            </div>
          </div>
