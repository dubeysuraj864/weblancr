  ...
  return (
    <>
      <div className="help my-10 flex flex-col md:flex-row justify-center md:mx-24">
        ...
        <div className="right m-6 md:w-[50vw]">
          <div className="text-2xl font-bold ">How we can help you?</div>
          <div className="my-5 leading-6 font-light">
          ...
          <div className=" ">
            <input
              type="email"
              className="bg-[#FAFAFA] w-[55vw] md:w-[24vw] px-4 py-4 rounded-full mr-2 "
          ...
          <div className="mt-6">
            <button className="underline text-[#3461FF] font-bold">
              More FAQ
            </button>
          </div>
        </div>
